...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("F:\\chooseSubjects\\MultipleChoice\\guns-student\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("qifanlee");
        ...
        dsc.setPassword("");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/graduation-design?autoReconnect=true&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8");
        ...
        strategy.setInclude(new String[]{"gra_team_intention"});
