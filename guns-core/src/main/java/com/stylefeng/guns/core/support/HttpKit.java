...
public class HttpKit {
    ...
    public static String sendGet(String url, Map<String, String> param) {
        ...
        try {
            ...
            connection.setRequestProperty("student-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
            // 建立实际的连接
            connection.connect();
            // 获取所有响应头字段
    ...
    public static String sendPost(String url, Map<String, String> param) {
        ...
        try {
            ...
            conn.setRequestProperty("student-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
            // 发送POST请求必须设置如下两行
